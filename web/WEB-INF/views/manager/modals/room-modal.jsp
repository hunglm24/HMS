...
<div class="room-management-modal" id="roomModal" aria-hidden="true">
    ...
    <div class="room-management-modal__dialog">
        ...
        <form class="room-management-form" method="post" action="${pageContext.request.contextPath}/manager/rooms/save-room">
            ...
            <input id="roomFloor" name="floorNumber" type="number" min="0" step="1">
            ...
            <textarea id="roomDescription" name="description" rows="3" maxlength="500"></textarea>
